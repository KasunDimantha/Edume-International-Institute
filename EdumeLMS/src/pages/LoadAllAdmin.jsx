       ...
       <Admin_navbar/>
        ...
        <div className=" justify-around w-full">
            ...
            <div className="bg-gray-300 p-3">
                ...
                <button onClick={() => (window.location.pathname = "/addAdmin")} class=" text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent mr-3 hover:bg-blue-500">
                Add New Admin
                </button>
