...
function About_Page () {
    ...
    return (
      ...
      <div className="bg-hero min-h-screen relative m-6 rounded-b-xl">
        
        {/* add transparent div */}
        <div className=' bg-gray-400 bg-opacity-60 size-6/12 rounded-br-3xl p-5 left-24 top-20 absolute' >
          ...
          <h4 className='text-xl font-bold pb-3 '> About Us</h4>
            ...
            <button class="bg-gray-500 bg-opacity-15 border border-slate-900 hover:bg-white hover:border-white text-black py-2 px-4 rounded right-20 bottom-12 absolute ">Lern more...</button>
