      ...
      <div className="  min-h-screen d-flex">
            ...
            <div className=" justify-around w-full">
                ...
                <div className="m-3 pr-16 flex justify-end ">
                    <button onClick={() => handleTabClick('addAdmin')} class=" text-green-700 font-semibold hover:text-white py-2 px-4 rounded-lg border border-green-500 hover:border-transparent mr-3 hover:bg-green-500">
                        Add New Admin
                    </button>
