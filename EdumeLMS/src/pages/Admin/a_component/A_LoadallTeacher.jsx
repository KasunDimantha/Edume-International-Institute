...
function A_LoadallTeacher() {
    ...
    const [activeTab, setActiveTab] = useState('loadTeacher');
        ...
        <div className="  min-h-screen d-flex">
            ...
            <div className=" justify-around absolute top-24 left-64 w-2/3">
                ...
                <div className="m-3 pr-16 flex justify-end ">
                    <button onClick={() => handleTabClick('addTeacher')} class=" text-green-700 font-semibold hover:text-white py-2 px-4 rounded-lg border border-green-500 hover:border-transparent mr-3 hover:bg-green-500">
                        Add New Lecture
                    </button>
            ...
            {activeTab === 'addTeacher' &&
                <div className='absolute top-20 left-64 w-2/3'>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <button onClick={() => handleTabClick('loadTeacher')} class="text-sm font-semibold leading-6 text-gray-900">Cancel</button>
                     </div>
                </div>
            }
        </div>
