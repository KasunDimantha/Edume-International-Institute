    ...
    return (   
      ...
      <div className="min-h-screen d-flex">
        ...
        <div className=" justify-around w-full">
            ...
            <button onClick={() => (window.location.pathname = "/loadAllSemester")} class=" text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent mr-3 hover:bg-blue-500">
                All Semester
            </button>
