    ...
    <>
            <section className="h-h100">
                ...
                <div className="flex justify-end relative font-sans right-9 -top-96">
                    ...
                    <button className="absolute top-20 right-28 text-base bg-[#36f136d2] pt-2 pb-2 pl-5 pr-5 rounded-xl border-none text-white font-bold cursor-pointer top-24 ">Explor More !</button>
                </div>
