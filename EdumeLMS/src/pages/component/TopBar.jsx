...
function TopBar() {
  return (
    ...
    <>
    <div>
      <div className="flex justify-between items-center bg-[#77764a] pt-4 pr-20 pb-3 pl-20 z-0">
            ...
            <div>
                <ul className="flex justify-center  relative h-0 -bottom-6">
                    <li className="mr-16 text-base cursor-pointer text-white "><a className="hover:text-lg hover:underline decoration-1 "><Link to="/">Home</Link></a></li>
                    ...
                    <li className="mr-16 text-base cursor-pointer text-white "><a className="hover:text-lg hover:underline decoration-1 "><Link to="/aboutPage">About Us</Link></a></li>
