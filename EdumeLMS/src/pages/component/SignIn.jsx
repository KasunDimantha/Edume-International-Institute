    ...
    <div className='h-h100 text-center'>
      ...
      <div className="flex justify-center absolute w-w90% text-center pl-5 pr-5 top-32 ">
        ...
        <div className="text-start font-sans rounded-xl bg-[#ffffff5e] w-w450 h-h500 m-5">
          ...
          <p className='mt-10 pl-16 font-bold text-lg'>Loging Using Social Networks</p>
          <div className="flex pl-16">
              <img src={img1} alt="facebook"  className="cursor-pointer w-8 h-8 mt-1 mr-3"/>
              <img src={img2} alt="google"    className="cursor-pointer w-12 h-12" />
              <img src={img3} alt="linedin"   className="cursor-pointer w-12 h-12"/>
          </div>
          <div className="mt-10 pl-16">
            <p className='font-bold mb-2'>User Name</p>
            <input type="text"  placeholder='User Name' className='border-non outline-none pt-1 pb-1 pl-2 pr-2 font-sans text-1xl'/>
          </div>
          ...
          <div className='flex justify-center mt-10'>
            <button className='text-5 border-none cursor-pointer bg-[#a83030d7] text-white pt-3 pb-3 pl-20 pr-20 rounded-xl'>Sign In</button>
          </div>
        ...
        <div className="text-start font-sans rounded-xl bg-[#ffffff5e] w-w450 h-h500 m-5">
          ...
          <p className='pl-16 text-lg font-bold mt-12'>Sign up and discover a great <br />amount of new opportunities!</p>
          <div className='flex justify-center mt-10'>
            <Link to="/signUpPage" ><button className='text-5 mt-14 border-none cursor-pointer bg-[#a83030d7] text-white pt-3 pb-3 pl-20 pr-20 rounded-xl'>Sign Up</button></Link>
          </div>
