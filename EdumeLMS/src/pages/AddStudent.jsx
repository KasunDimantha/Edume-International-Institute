                ...
                <div class="space-y-12">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" readOnly value="Student id" name="username" id="username" autocomplete="username" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Student Id"></input>
                            </div>
                        </div>
                        </div>
